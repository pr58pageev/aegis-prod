...
?>
<div
    class="footer-block" <? if (Config::get('FOOTER_IMG')): ?> style='background-image: url("<?= CFile::GetPath(Config::get('FOOTER_IMG')); ?>");'<? endif; ?> >
            ...
            <div class="footer-block__menu--column footer-column">
                <div class="footer-column__logo">
                    <a href="/" class="footer-column__logo--footer-logo">
                        <img alt="logo" src="/local/templates/sotbit_origami/theme/footers/2/logo_white.png">
                    </a>
                </div>
