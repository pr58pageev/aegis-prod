...
var DateTimePickers = function() {
    ...
    var _componentDaterange = function() {
        ...
        $('.daterange-locale').daterangepicker({
            ...
            ranges: {
                ...
                'РџРѕСЃР»РµРґРЅРёРµ 7 РґРЅРµР№': [moment().subtract(6, 'days'), moment()],
                'РџРѕСЃР»РµРґРЅРёРµ 30 РґРЅРµР№': [moment().subtract(29, 'days'), moment()],
                'Р­С‚РѕС‚ РјРµСЃСЏС†': [moment().startOf('month'), moment().endOf('month')],
                'РџСЂРѕС€РµРґС€РёР№ РјРµСЃСЏС†': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
            },
            locale: {
                applyLabel: 'Р’РїРµСЂРµРґ',
                cancelLabel: 'РћС‚РјРµРЅР°',
                startLabel: 'РќР°С‡Р°Р»СЊРЅР°СЏ РґР°С‚Р°',
                endLabel: 'РљРѕРЅРµС‡РЅР°СЏ РґР°С‚Р°',
                customRangeLabel: 'Р’С‹Р±СЂР°С‚СЊ РґР°С‚Сѓ',
                daysOfWeek: ['Р’СЃ', 'РџРЅ', 'Р’С‚', 'РЎСЂ', 'Р§С‚', 'РџС‚','РЎР±'],
    ...
    var _componentPickadate = function() {
        ...
        $('.pickadate-translated').pickadate({
            monthsFull: ['Janvier', 'FГ©vrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'AoГ»t', 'Septembre', 'Octobre', 'Novembre', 'DГ©cembre'],
        ...
        $('.pickadate-format').pickadate({
            ...
            // Escape any вЂњruleвЂќ characters with an exclamation mark (!).
