...
<?if($arParams['NAME_MODAL_BUTTON']):?>
    <div class="slam-easyform">
		<a type="button" class="slam" data-toggle="modal" data-target="#modal<?=$FORM_ID?>"><?=$arParams['NAME_MODAL_BUTTON']?></a>
    </div>
<?endif;?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close close_cstm">&#10006;</button>
                    <? if($arParams['FORM_NAME']): ?>
                        <div class="title title_cstm"><?=$arParams['FORM_NAME']?></div>
                    <? endif?>
                </div>
                            ...
                            <div class="row">
                                ...
                                if(!empty($arResult['FORM_FIELDS'])):
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <?endif;?>
                                        <button type="submit" style="color:white !important;background:#e65100;" class="btn btn-primary pull-right submit-button" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>"><?=$arParams['FORM_SUBMIT_VALUE']?></button>
                                    </div>
                                <?endif;?>
                            </div>
                        </form>
