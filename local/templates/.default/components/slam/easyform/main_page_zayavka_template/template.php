...
?>
<div class="sotbit_order__title cstm_tile2" style="box-shadow: none;">Отправьте заявку</div>
    ...
    <form id="<?=$FORM_ID?>"
        ...
        <div class="row">
            ...
            if(!empty($arResult['FORM_FIELDS'])):
                foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                    ...
                    if($arField['TYPE'] == 'textarea'):?>
                          ...
                          <div class="col-md-12">
                               ...
                               <p class="popup-window-field_description">
                                ...
                                <? endif; ?>
                                <div>
                                    <textarea class="form-control textarea_cstm" id="<?=$arField['ID']?>" rows="1" name="<?=$arField['NAME']?>" <?=$arField['PLACEHOLDER_STR'];?> <?=$arField['REQ_STR']?>><?=$arField['VALUE'];?></textarea>
                                </div>
                            </div>
                          </div>
                 ...
                 <div class="form-group">
                               <p class="popup-window-field_description">
                                ...
                                <input class="form-control feedback_block__form_input <?if($arField['NAME']=='FIELDS[PHONE]'){ echo 'js-phone';}?>" type="<?=$arField['TYPE'];?>" id="<?=$arField['ID']?>" name="<?=$arField['NAME']?>" value="<?=$arField['VALUE'];?>" <?=$arField['PLACEHOLDER_STR'];?> <?=$arField['REQ_STR']?> <?=$arField['MASK_STR']?>>
                            </div>
                        </div>
                    <?endif;endif;
                endforeach;?>
                ...
                <div class="confidential-field conf_cstm" style=" ">
                <div class="feedback_block__compliance form-group">
        ...
        endforeach; ?>
                ...
                <div class="popup-window-submit_button new_btn_block_form" >
