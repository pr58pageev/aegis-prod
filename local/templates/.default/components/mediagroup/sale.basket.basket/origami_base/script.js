...
$('.basket-item-amount-filed-block input').change(function(){
console.log($(this).val());

var koef = $(this).parents('.basket-items-list-item-container').find('.koef_cart').attr('data-koef');
console.log(koef);
$(this).parents('.basket-items-list-item-container').find('.koef_cart').html(koef);
});
*/