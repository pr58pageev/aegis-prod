...
<div class="page" id="main-header">
    <div>
        ...
        <div class="header_top_bottom_line">
            <div class="header_top_block puzzle_block no-padding main-container">
                ...
                <div class="header_top_block__cabinet">
                    <?$APPLICATION->IncludeComponent(
                        "bitrix:menu",
                ...
                <div class="block__feedback_and_basket">
                    <?if(\Sotbit\Origami\Helper\Config::get('HEADER_CALL') == 'Y' && \Bitrix\Main\Loader::includeModule('sotbit.orderphone')):?>
                        <div class="header_info_block__item header_info_block__feedback">
                            <div class="header_info_block__feedback_button
                            fonts__main_comment" onclick="callbackPhone('<?=SITE_DIR?>',
                                    '<?=SITE_ID?>', this)">
