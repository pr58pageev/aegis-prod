...
<? if(!empty($_SESSION['POPULAR_DETAIL_ITEMS'])):?>
  <p class="small-product__title fonts__middle_title ">Товары, продаваемые совместно:</p>

<div class="small-product-blocks ">
  <div class="small-producs "> 
  ...
  <?
     ...
     $arrFilterPopular = array('ID' => $_SESSION['POPULAR_DETAIL_ITEMS']);
