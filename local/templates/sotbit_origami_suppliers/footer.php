...
<!-- footer -->
<?
include $_SERVER['DOCUMENT_ROOT'].'/local/templates/sotbit_origami_suppliers/theme/footers/1/content.php';
if (file_exists($_SERVER['DOCUMENT_ROOT'].'/local/templates/sotbit_origami_suppliers/theme/footers/1/style.css')
) {
...
<?$APPLICATION->IncludeComponent(
    ...
    array(
        "AREA_FILE_SHOW" => "file",
        "PATH" => SITE_DIR."include/sotbit_origami/btn_top.php"
    )
);?>
