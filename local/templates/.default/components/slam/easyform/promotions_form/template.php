...
<div class="contacts-call_back-title-wrapper">
                    <div class="contacts-call_back-title"><?=$arParams['FORM_NAME']?></div>
                    </div>
            ...
            if(!empty($arResult['FORM_FIELDS'])):
                foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                    ...
                    if($arField['TYPE'] == 'textarea'):?>
                        <div class="form-block-right form-group text-area-cont">
                          
                              
                         
                                    <textarea <?=$arField['PLACEHOLDER_STR'];?> class="form-control contacts-textarea" id="<?=$arField['ID']?>" name="<?=$arField['NAME']?>"  <?=$arField['REQ_STR']?>><?=$arField['VALUE'];?></textarea>
...
<?php else: ?>
                 ...
                 <div class="form-group form_row">
                                ...
                                <input class="form-control feedback_block__form_input <?if($arField['NAME']=='FIELDS[PHONE]'){ echo 'js-phone';}?>" type="<?=$arField['TYPE'];?>" id="<?=$arField['ID']?>" <?=$arField['PLACEHOLDER_STR'];?> name="<?=$arField['NAME']?>" value="<?=$arField['VALUE'];?>" <?=$arField['REQ_STR']?> <?=$arField['MASK_STR']?>>
                            </div>
