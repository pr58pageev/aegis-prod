            ...
            <div class="card-body">
                ...
                <form method="post" id="add-org" class="col-md-12 sale-profile-detail-form"
                    ...
                    <div class="row">
                        <?
                        $cnt= 0;
                        foreach ($arResult["ORDER_PROPS"] as $keyyy => $block) {
                            $cnt++;
                         
                            if (!empty($block["PROPS"])) {
                                ?>
                                <div class="row-item col-md-12 сol-lg-6 col-xl-6 my-2" <?if($cnt>=2){echo 'style="display:none;"';}?>>
                                        ...
                                        <div class="card-body">
                                            ...
                                            foreach ($block["PROPS"] as $property) {
                                                ...
                                                if(empty($currentValue)){
                                                    $currentValue = $arCustomProps[$property['CODE']];
                                                }
                                                ...
                                                <div class="form-group form-group-float<? if ($property["TYPE"] == "CHECKBOX" || $property["TYPE"] == 'Y/N'): ?> form-check<? endif; ?>">
                                                    <label for="sppd-property-<?= $key ?>" class="form-check-label">
                                                        <?= $property["NAME"] ?>:
                        ...
                        <div class="col-md-offset-3 col-sm-9 sale-personal-profile-btn-block">
                            ...
                            <input type="submit" class="btn btn_b2b" name="save" value="<?echo GetMessage("SOA_SALE_SAVE") ?>">                            &nbsp;
                            <input type="submit" class="btn btn-light"  name="cancel" value="<?echo GetMessage("SOA_SALE_RESET")?>">
                        </div>
                    </form>
...
<script>
      $( document ).ready(function() {
            ...
            if($('#sppd-property-34').val()=='Юридическое лицо'){
                 var maxLen = 10;
                 $('#sppd-property-34').attr('data-max',10);
                 //$("#ORDER_PROP_10").mask("9999999999");
            }else{
                 var maxLen = 12;
                 $('#sppd-property-34').attr('data-max',12);
                 //$("#ORDER_PROP_10").mask("999999999999");
            }

            $('#sppd-property-34').change(function(){
                if($('#sppd-property-34').val()=='Юридическое лицо'){
                 var maxLen = 10;
                 $('#sppd-property-34').attr('data-max',10);
                 //$("#ORDER_PROP_10").mask("9999999999");
  ...
  $('#sppd-property-10').keyup( function(){
