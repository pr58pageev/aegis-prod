            ...
            (function () {
                    ...
                    function setMobileFilterEvents() {
                        ...
                        function reset() {
                            ...
                            if (document
                                .querySelectorAll(".bx_filter_block_wrapper.filter_block_wrapper_max_height")
                                .length > 0) {
                                ...
                                for (let i = 0; i < filterBlockWrapperMaxHeight.length; i++) {
                                    filterBlockWrapperMaxHeight[i]
                                        .setAttribute("class", "bx_filter_block_wrapper");
                                }
                            }
                        }
                        ...
                        function displayApplyNumber() {
                            ...
                            if (isSomeItemSelected(filterItems)) {
                                ...
                                let filterBlockWrapperMaxHeight = mobileFilter
                                    .querySelectorAll(".bx_filter_block_wrapper");

                                for (let i = 0; i < filterBlockWrapperMaxHeight.length; i++) {
                                    filterBlockWrapperMaxHeight[i]
                                        .setAttribute("class", "bx_filter_block_wrapper filter_block_wrapper_max_height");
                                }
