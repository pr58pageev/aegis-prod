...
$arTemplateListView = array("card", "list", "column");
$viewDefault = "card";
...
(Option::get('HEADER') == 5) ? $mobileFilter = true : $mobileFilter = false;
?>

	<div class="catalog_content__sort_horizon">
        <a href="#filter_href" class="filter_border_animbate">Расширенный поиск</a>
                ...
                <div class="catalog_content__sort_horizon_btn-block">
                    ...
                    foreach($arTemplateListView as $view)
                    {
                        ...
                        if($active)
                        {
                            ...
                            href="<?=$APPLICATION->GetCurPageParam("view=".$view, array("view", "ajaxFilter"), false);?>"
                            rel="nofollow"
