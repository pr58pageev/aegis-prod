...
let buildTabsProductBlockCustom = (function () {
    function buildTabsProductBlockCustom () {
        document.addEventListener("DOMContentLoaded", function () {
            const blockWrapper = document.querySelector('.small-product-blocks.cstm');
            if (!blockWrapper) {
                return;
            }
            const productsBlock = Array.prototype.slice.call(blockWrapper.querySelectorAll('.small-product.cstm'));
            ...
            productsBlock.forEach(function (item, i) {
                const titleBlock = item.querySelector('.small-product__title.cstm');
                listTitlesBlock.push(titleBlock);
                tabs.querySelector('.swiper-slide.cstm').appendChild(titleBlock.cloneNode(true));
            ...
            new Swiper('.small-product__tabs-title.cstm', {
                slidesPerView: 'auto',
                freeMode: true,
            });

            const cloneTitleTabs = Array.prototype.slice.call(tabs.querySelectorAll('.small-product__title.cstm'));
    ...
    clipText(34);
    return buildTabsProductBlockCustom;
}) ();
