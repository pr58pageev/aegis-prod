...
else
{
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "IBLOCK_TYPE" => Option::get("sotbit.b2bcabinet","DOCUMENT_IBLOCK_TYPE", "", SITE_ID),
            "IBLOCK_ID" => Option::get("sotbit.b2bcabinet","DOCUMENT_IBLOCK_ID", "", SITE_ID),
            ...
            "SEF_FOLDER" => "/b2bcabinet/documents/",
            "SEF_MODE" => "Y",
            "SET_LAST_MODIFIED" => "N",
            "SET_STATUS_404" => "N",
            "SET_TITLE" => "Y",
