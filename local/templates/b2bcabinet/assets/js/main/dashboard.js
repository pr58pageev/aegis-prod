...
BX.showWait = function(node, msg)
{
    ...
    var obMsg = node.bxmsg = document.body.appendChild(preloader);
...
function _adjustWait()
{
    ...
    this.bxmsg.style.top = '50%';

    if (this == BX.GetDocElement())
    {
        this.bxmsg.style.right = '50%';
    }
    else
    {
        this.bxmsg.style.left = '50%';
    }
}
...
function putBodyUnderAdminPanel() {
    if (document.getElementById("bx-panel")) {
        ...
        let adminPanel = document.getElementById("bx-panel"),
            navBar = document.querySelector("#header-two.fixed-top"),
            navBarTopPosition = adminPanel.clientHeight - document.documentElement.scrollTop,
            sidebarMenu = document.querySelector(".sidebar .sidebar-content");
