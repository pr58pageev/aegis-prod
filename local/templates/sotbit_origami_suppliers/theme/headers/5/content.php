...
Asset::getInstance()->addCss(SITE_DIR . "local/templates/sotbit_origami/theme/headers/5/style_include.css");
Asset::getInstance()->addCss(SITE_DIR . "local/templates/sotbit_origami/theme/headers/5/header_no_regions.css");
        ...
        <div class="header-three__personal">
            ...
            <?else:?>
                <a class="header-three__personal-link" href="<?=Config::get('PERSONAL_PAGE')?>">
                    ...
                    <span><?=Loc::getMessage('HEADER_3_ENTER')?></span>
                </a>
            <?endif;?>
        </div>
        <?
