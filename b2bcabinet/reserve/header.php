...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/include/sotbit_origami/files/b2b.css");
...
<div class="navbar navbar-expand-md navbar-dark fixed-top">
    <div class="navbar-brand">
        <a href="/" class="d-inline-block">
            <img class="header_logo" src="<?= Option::get("sotbit.b2bcabinet", "LOGO", "", SITE_ID) ?>" alt="">
        </a>
    </div>
    <div class="d-md-none">
