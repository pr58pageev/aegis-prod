            ...
            <div class="card mb-0">
                ...
                >
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label><?=Loc::getMessage("REGISTER_FIELD_LAST_NAME")?>: <span>*</span> </label>
                                    <div class="form-group form-group-feedback form-group-feedback-right">
                                        <input required
                                               type="text"
                                ...
                                foreach ($arResult["OPT_FIELDS"][$group['ID']] as $FIELD) {
                                    ...
                                    ?>
                                        <div class="col-md-12">
                                            <label><?=Loc::getMessage("REGISTER_FIELD_" . $FIELD) ?>: <span>*</span> </label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <? foreach ($arResult['OPT_ORDER_FIELDS'][$group['ID']] as $order): ?>
                                        <?if($order['NAME']):?>
                                            <label><?=$order['NAME']; ?>: <span>*</span> </label>
                                            <div class="form-group form-group-feedback form-group-feedback-right">
                                        ...
                                        <?if($order['CODE']['FILE'] == 'Y'):?>
                                            ...
                                            $APPLICATION->IncludeComponent(
                                                ...
                                                "b2bcabinet_drag_n_drop",
                                                [
                                                    "INPUT_NAME" => $group['ID'] ."FILES",
                                                    "MULTIPLE" => "Y",
                                                    "MODULE_ID" => "main",
                                                    "MAX_FILE_SIZE" => "",
                                                    "ALLOW_UPLOAD" => "F",
                                    ...
                                    <div class="col-md-12">
                                        <? foreach ($arResult["SHOW_FIELDS"] as $FIELD) {
                                            ...
                                            ?>
                                                <label><?=Loc::getMessage("REGISTER_FIELD_" . $FIELD) ?>: <span>*</span> </label>
                                                <div class="form-group form-group-feedback form-group-feedback-right">
                                                    <input required type="password" class="form-control" placeholder="<?=Loc::getMessage("REGISTER_PLACEHOLDER_" . $FIELD) ?>"
                                        ...
                                        <?if ($arResult["USE_CAPTCHA"] == "Y"):?>
                                            ...
                                            <div class="password_recovery-captcha">
                                                <div class="form-group form-group-feedback form-group-feedback-right password_recovery-captcha_input">
                                                    <input type="text" class="form-control" name="captcha_word" maxlength="50" autocomplete="off" placeholder="<?=Loc::getMessage("CAPTCHA_REGF_PROMT") ?>">
                                                </div>
                                            </div>
                        ...
                        <input type="hidden" name="sotbit_auth_register" value="<?=Loc::getMessage('AUTH_REGISTER_WORD')?>"/>
                        <div class="btnBlock">
                            <button type="submit" class="btn bg-teal-400 btn-labeled btn-labeled-right"><b><i class="icon-plus3"></i></b><?=Loc::getMessage('AUTH_REGISTER')?></button>
