...
foreach ($arResult['BASKET_ITEM_RENDER_DATA'] as $key => $value) {
   ...
   $arResult['BASKET_ITEM_RENDER_DATA'][$key]['NAME'] = 'Новое название';
}
foreach ($arResult['GRID']["ROWS"] as $key => $value) {
   
   $arResult['GRID']["ROWS"][$key]['NAME'] = 'Новое название2';
}
foreach ($arResult['ITEMS']["AnDelCanBuy"] as $key => $value) {
   
   $arResult['ITEMS']["AnDelCanBuy"][$key]['NAME'] = 'Новое название3';
}
*/
