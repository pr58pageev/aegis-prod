...
<div class="bx-sidebar-block bx_filter_wrapper" id="filter_href">
    <div class="bx_filter">
...
// $arItem["VALUES"] //Тут значение от начальной цены до конечной
...
//                    $key = $arItem["ENCODED_ID"];
                    if (in_array($arItem["CODE"],$arResult['SLIDER_PROPS'])):
                        ...
                        $step_num = 4;
                        $slider_items[0] = $arItem["VALUES"]["MIN"]["HTML_NAME"];
                        $slider_items[4] = $arItem["VALUES"]["MAX"]["HTML_NAME"];
...
?>
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    $display_none = (in_array($arItem["CODE"],$arResult['SLIDER_PROPS']))?'display: none;':'';
                    ...
                    if ($arItem["CODE"] == 'RAZMER'):?> filter-size<? endif ?>" data-propid="<?= $arItem["ID"] ?>" style="<?=$display_none?>">
                        <span class="bx_filter_container_modef"></span>
                        <div class="bx_filter_parameters_box_title fonts__middle_text"
                             onclick="smartFilter.hideFilterProps(this)">
                            <span>
                            ...
                            <div class="bx_filter_parameters_box_container">
                                ...
                                ?>
                                    <div class="radio_container_wrapper">
                                        ...
                                        <div class="bx_filter_parameters_open_all" onclick="openAllToggleRadio(this)">
                                            <span
                                                class="bx_filter_parameters_open_all_open"><?= GetMessage("CT_BCSF_SET_FILTER_ALL_LIST") ?></span>
                                            <span
                                                class="bx_filter_parameters_open_all_close"><?= GetMessage("CT_BCSF_SET_FILTER_ALL_ROLL_UP") ?></span>
                ...
                <div class="bx_filter_popup_result fonts__middle_comment <?= Config::get('MENU_SIDE') == 'left' ? 'right' : 'left' ?>"
