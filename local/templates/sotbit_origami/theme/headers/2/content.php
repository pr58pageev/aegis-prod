...
<?if(!$USER->IsAuthorized() && ($_GET['AUTH_SHOW']=='Y' || $_GET['forgot_password'] == 'yes')): // && $page != '/personal/cart/' && $page != '/personal/order/make/'?>

   <!-- Modal Auth -->
<div <?if($_GET['AUTH_SHOW']=='Y' ):?>data-open-on-load<?endif;?> class="modal-wrapper j_modal modal-auth redirect" id="modal-auth">
...
<!-- ./ End of Modal Reg -->
        ...
        <!-- Modal ForgetPass -->
        <div     <?if($_GET['forgot_password']=='yes' ):?>data-open-on-load <?endif;?> class="modal-wrapper j_modal modal-forget" id="modal-forget">
            <div class="modal modal--medium">
                <!-- wrap -->
                ...
                if(
                    ...
                    <div class="header-two__contact-phone-link">
                        ...
                        <?$APPLICATION->IncludeComponent(
                            ...
                            array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => SITE_DIR."include/sotbit_origami/contacts_phone2header.php")
                        );
                        ?>
                        <!--<svg class="header-two__contact-arrow" width="18" height="18">
                            <use xlink:href="/local/templates/sotbit_origami/assets/img/sprite.svg#icon_dropdown_big"></use>
 ...
 ?>  <p><?=$email?></p>
                <?else:?>
                    ...
                    <a href="<?=Config::get('PERSONAL_PAGE')?>">
                     ...
                     <? $pageLogin = $APPLICATION->GetCurPageParam("AUTH_SHOW=Y", array("AUTH_SHOW","forgot_password"));?>
...
<?
    ...
    <div class="header-two__nav">
        ...
        <?$APPLICATION->ShowViewContent("MENU_DROPDOWN");?>
    </div>
    <?
    $typeFix = "";
